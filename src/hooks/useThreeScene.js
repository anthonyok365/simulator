...
import { PANEL_SPEC, CTRL_MAX_VOC, INV_MIN_V, INV_MAX_V, OWNER, GROUP, ZONES, RED, BLACK } from '../utils/constants';
...
export function useThreeScene() {
  ...
  useEffect(() => {
    ...
    // Lights
    const hemi = new THREE.HemisphereLight(0x8fa0a8, 0x1a1712, 0.9);
    scene.add(hemi);
    ...
    scene.add(sun);
    const fillLight = new THREE.DirectionalLight(0x6a90ff, 0.18);
